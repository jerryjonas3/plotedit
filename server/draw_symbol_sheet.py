...
def main(path="../out/rp2-symbols.pdf"):
    ...
    row(19.4, "6.1.6  ENHANCED ERS — the MARK IN THE LENS HOUSING codes the beam angle", [
    ...
    row(15.4, "6.2  FRESNEL — proud lens ring, and the OVAL BEAM FRESNEL (= an ETC PARNel)        6.3  PAR", [
    ...
    row(11.4, "6.16  LED — dots = number of colors     6.8  MOVERS — dashed swing radius     6.9  PRACTICAL", [
    ...
    row(7.4, "6.6  CYC — arrow BESIDE the body is the focus direction     "
    ...
    s.text(0.35, 5.0, "6.18  LINE WEIGHTS — three, and only three", size=8.5, bold=True)
    ...
    for title, names in groups:
        s.text(x, 4.3, title, size=7.5, bold=True)
